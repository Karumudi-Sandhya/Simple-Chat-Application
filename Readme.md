...
* Lightweight front-end chat application
...
* JavaScript – Chat logic, DOM manipulation, and interactivity
...
* Browser Local Storage API is used for message persistence
...
├── script.js      # Chat logic and storage
...
* Learned how to manage dynamic data using JavaScript

* Improved understanding of local storage usage
...
* Implement multi-user simulation

* Add chat export option
